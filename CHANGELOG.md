...
- #680: Add hostname, port, output, and password env variables to propgeo-cli (@ptsilva)
...
## [1.30.0] = 2022-11-22
### Added
- bdc80a7: Add WHERE expressions ([more info](https://propgeo.com/topics/filter-expressions))
...
- #633: Added "clear" command in the propgeo-cli (@CaioDallaqua)
- #634: Added -x flag to propgeo-cli (@sign0)
...
- #603: Fix propgeo-cli output showing protocol size when piping (@bb)
...
### Fixed
- 6092f73: Better handle connection errors in propgeo-cli
...
### Fixed
- 9d27533: Fix infinite loop on propgeo-cli connection failure.
...
- #500: Fix PropGeo-cli not propertly handling quotes. (@vthorsell)
...
- e47540b: Added auth flag to propgeo-benchmark.
...
- #396: Add distance_to function to the propgeo namespace in lua. (@rshura)
...
- #183: Include propgeo-cli in Docker image (@jchamberlain)
...
### Fixed
- b1c76d7: propgeo-cli auto doesn't auto reconnect
