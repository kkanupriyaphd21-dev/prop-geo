...
- Assign [Webhooks](http://propgeo.com/commands/sethook) to Geofences.
...
*PropGeo also allows for [Webhooks](http://propgeo.com/commands/sethook) to be assigned Geofences.*
