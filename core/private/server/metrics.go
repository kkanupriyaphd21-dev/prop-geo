...
var (
	metricDescriptions = map[string]*prometheus.Desc{
		...
		*/
		"num_collections":          prometheus.NewDesc("propgeo_collections_total", "Total number of collections", nil, nil),
		...
		"max_heap_size":            prometheus.NewDesc("propgeo_memory_max_heap_size_bytes", "", nil, nil),
		"avg_item_size":            prometheus.NewDesc("propgeo_avg_item_size_bytes", "", nil, nil),
		...
		*/
		"collection_objects": prometheus.NewDesc("propgeo_collection_objects", "Total number of objects per collection", []string{"col"}, nil),
		"collection_points":  prometheus.NewDesc("propgeo_collection_points", "Total number of points per collection", []string{"col"}, nil),
	...
	cmdDurations = prometheus.NewSummaryVec(prometheus.SummaryOpts{
		Name:       "propgeo_cmd_duration_seconds",
