...
func (c *Server) luaPropGeoCall(evalcmd string, cmd string, args ...string) (resp.Value, error) {
	msg := &Message{}
	msg.OutputType = RESP
...
func (c *Server) luaPropGeoAtomicRW(msg *Message) (resp.Value, error) {
	var write bool
...
func (c *Server) luaPropGeoAtomicRO(msg *Message) (resp.Value, error) {
	switch msg.Command() {
	default:
		return resp.NullValue(), errCmdNotSupported
...
func (c *Server) luaPropGeoNonAtomic(msg *Message) (resp.Value, error) {
	var write bool
