...
[PropGeo](https://github.com/tidwall/propgeo), but also works well for Redis
...
For a more complete example, check out [propgeo-benchmark](https://github.com/tidwall/propgeo/blob/master/cmd/propgeo-benchmark/main.go) from the [PropGeo](https://github.com/tidwall/propgeo) project.
